import{l as d,d as n}from"./utilidades-f9bac2a0.js";function r(o){const i=`<p class='text-xl text-bold my-4' >${new Date(o.dataPedido).toLocaleDateString("pt-BR",{hour:"2-digit",minute:"2-digit"})}</p>
